{
    ...
    "description": """
        This module provides a set of RESTful APIs that allow employees to perform essential HR functions directly from external systems or mobile applications. Key features include:
            ...
            - Check-In and Check-Out using API
            - View current and past leave balances
            - Submit leave requests
            - Track leave status (approved, pending, rejected)
            - Access and download salary slips

            This module is ideal for building employee self-service portals or mobile apps integrated with Odoo HR.
            """,
    "author": "scidecs",
